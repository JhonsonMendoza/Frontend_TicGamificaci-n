...
const Navbar: React.FC<NavbarProps> = ({ children }) => {
  ...
  const getLinkClasses = (href: string) => {
    const baseClasses = "font-medium transition-all duration-200 px-3 py-2 rounded-lg text-sm";
    if (isActiveLink(href)) {
      return `${baseClasses} text-indigo-700 bg-indigo-50 shadow-sm`;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href={isAuthenticated ? "/dashboard" : "/"} className="flex items-center space-x-3 hover:opacity-90 transition-opacity">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-gray-500 font-medium leading-tight">Plataforma Educativa</span>
              </div>
            </Link>
          </div>
